  ...
  term
    ...
    .action(async (opts) => {
      ...
      const expected: VerifyItem[] = [
        { label: 'data_dir', path: base, kind: 'dir', required: true },
        { label: 'Bases', path: path.join(base, 'Bases'), kind: 'dir', required: true },
        { label: 'Config', path: path.join(base, 'Config'), kind: 'dir', required: true },
        { label: 'Logs', path: path.join(base, 'Logs'), kind: 'dir', required: true },
        { label: 'MQL5', path: path.join(base, 'MQL5'), kind: 'dir', required: true },
        { label: 'Profiles', path: path.join(base, 'Profiles'), kind: 'dir', required: true },
        { label: 'Templates', path: path.join(base, 'Templates'), kind: 'dir' },
        { label: 'Tester', path: path.join(base, 'Tester'), kind: 'dir', required: true },
