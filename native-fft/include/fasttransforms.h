...
#define REVERSAL_WAVE_RESULT_OK 0
#define REVERSAL_WAVE_RESULT_INVALID_ARGUMENT -1
#define REVERSAL_WAVE_RESULT_NOT_ENOUGH_DATA -2

#define REVERSAL_WAVE_MODE_HIGHPASS 1
#define REVERSAL_WAVE_MODE_EMPHASIZE_PIVOT 2
#define REVERSAL_WAVE_MODE_USE_HANN 4
#define REVERSAL_WAVE_MODE_EXTENDED_BAND 8

#define REVERSAL_WAVE_FLAG_BULLISH       1
#define REVERSAL_WAVE_FLAG_BEARISH       2
#define REVERSAL_WAVE_FLAG_LOW_CONFIDENCE 4
#define REVERSAL_WAVE_FLAG_WARMUP        8
