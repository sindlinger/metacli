...
- Não é uma sequência de passos (init/compile/run); é uma regra de UX: o usuário/IA não deve decorar parâmetros.
- Parâmetros avançados continuam disponíveis, mas são opcionais.
